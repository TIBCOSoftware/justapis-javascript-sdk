...
extend(APGateway.prototype, {
  ...
  cache: function(active) {
	 ...
	 *			other optional keys:
	 *			{
	 *				includeSubdomains {boolean} - weather to enfore public key rule on subdomains
	 *				reportOnly {boolean} - weather to use Public-Key-Pins-Report-Only mode instead of Public-Key-Pins
